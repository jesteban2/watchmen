...
CHEF_SERVER_NAME="watchmen-chef" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="watchmen-chef-vlsytc4w4lvrdxjk.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
  ...
  (cat <<-JSON
    {
      ...
      "policy_name": "watchmen",
      "policy_group": "watchmen"
    }
JSON
