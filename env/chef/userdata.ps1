<powershell>
 ...
 $env:CHEF_SERVER_NAME = "watchmen-chef" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "watchmen-chef-vlsytc4w4lvrdxjk.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
